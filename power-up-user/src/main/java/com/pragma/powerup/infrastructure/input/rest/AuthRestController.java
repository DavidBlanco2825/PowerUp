...
public class AuthRestController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Client account created", content = @Content),
    ...
    @PostMapping("/client")
    public ResponseEntity<Void> createClientAccount(@RequestBody @Valid ClientRequestDto clientRequestDto) {
        this.clientHandler.createClientAccount(clientRequestDto);
